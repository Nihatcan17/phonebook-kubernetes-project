...
output "master_public_dns" {
  value = "${aws_instance.master.public_dns}:30001"
}

output "master_public_ip" {
  value = "${aws_instance.master.public_ip}:30002"
}

output "worker_public_dns_" {
  value = "${aws_instance.worker.public_dns}:30001"
}

output "worker_public_ip" {
  value = "${aws_instance.worker.public_ip}:30002"
}
